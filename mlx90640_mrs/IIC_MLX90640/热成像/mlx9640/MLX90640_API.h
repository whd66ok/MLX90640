...
#define SCALEALPHA 0.000001
  ...
  typedef struct
   ...
   // int MLX90640_GetFrameData(uint8_t slaveAddr, uint16_t *frameData);
        int MLX90640_GetFrameData(uint8_t slaveAddr, unsigned short *frameData);
    ...
    void MLX90640_CalculateTo2(uint16_t *frameData, const paramsMLX90640 *params, float emissivity, float tr, float *result);
#endif
